...
(function() {
  'use strict';
  var AnimationSystem, AudioSystem, BulletAgeSystem, CollisionSystem, DeathThroesSystem, Engine, EntityCreator, FrameTickProvider, GameConfig, GameManager, GameState, GunControlSystem, Helper, HudSystem, KeyPoll, MotionControlSystem, MovementSystem, RenderSystem, SystemPriorities, WaitForStartSystem;
