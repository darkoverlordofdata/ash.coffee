...
ash.core.Engine = function() {
  ...
  this.entityNameChanged = this.entityNameChanged.bind(this);
  this.entityList = new ash.core.EntityList();
  this.entityNames = new ash.signals.Dictionary();
  this.systemList = new ash.core.SystemList();
  this.families = new ash.signals.Dictionary();
  this.updateComplete = new ash.signals.Signal0();
}

Object.defineProperties(ash.core.Engine.prototype, {
