...
ash.fsm.EngineState.prototype.addInstance = function(system) {
  return this.addProvider(new ash.fsm.DynamicSystemProvider(system));
};
...
ash.fsm.EngineState.prototype.addSingleton = function(type) {
  return this.addProvider(new ash.fsm.StateSystemMapping(type));
};
...
ash.fsm.EngineState.prototype.addMethod = function(method) {
  return this.addProvider(new ash.fsm.SystemInstanceProvider(method));
};
...
ash.fsm.EngineState.prototype.addProvider = function(provider) {
  var mapping;
  mapping = new ash.fsm.SystemSingletonProvider(this, provider);
